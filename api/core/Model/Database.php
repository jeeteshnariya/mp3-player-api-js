...
class Database
{
    ...
    public function __construct($db_name, $db_user = 'root', $db_pass = 'root', $db_host = 'localhost', $db_port = 3306, $db_socket = false)
    {
        ...
        if ($this->pdo === null) {
            try {
                if (!$this->db_socket) {
                    ...
                    $pdo = new PDO("mysql:unix_socket=/home/{$this->db_socket}/.mysql/mysql.sock;dbname={$this->db_name};host={$this->db_host};port={$this->db_port}", $this->db_user, $this->db_pass);
                }
